(function($) {
  $.fn.readGitHub = function(options) {
    return this.each(function() {
      ...
      // Place meta - We can add thing using this to the code if needed for not im removing it. 
      //var meta = '<div class="github-meta"><a href="https://github.com/' + config.repo + '/blob/' + config.branch + '/' + config.file + '" target="_blank">' + config.file + '</a></div>'
      var meta = '';
